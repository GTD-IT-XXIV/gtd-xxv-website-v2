...
const days = [
  {
    "card": {
      ...
      "label": {
        ...
        "twShadow": "[text-shadow:_2px_2px_0_#86371E] md:[text-shadow:_3px_3px_0_#86371E]",
    ...
    "popup": {
      "twBackground": "bg-gradient-to-t from-[#233C55] from-[2.47%] to-[#8A90C9] to-[94.42%]",
  ...
  },
  {
    "card": {
      ...
      "label": {
        ...
        "twShadow": "[text-shadow:_2px_2px_0_#B86635] md:[text-shadow:_5px_5px_0_#B86635]",
    ...
    "popup": {
      "twBackground": "bg-gradient-to-b from-[#F9E6B5] from-[6.68%] to-[#328A7A] to-[93.32%]",
      "video": "https://www.youtube-nocookie.com/embed/dQw4w9WgXcQ",
  ...
  },
  {
    "card": {
      ...
      "label": {
        ...
        "twShadow": "[text-shadow:_2px_2px_0px_#484F2D] md:[text-shadow:_4px_4px_0px_#484F2D]",
        "twRotate": "rotate-[-9.19deg]",
      },
      "date": {
        "text": "8 Aug",
    ...
    "popup": {
      "twBackground": "bg-gradient-to-b from-[#DBFFD6] from-[0.39%] to-[#4C5F02] to-[92.62%]",
      "video": "https://www.youtube-nocookie.com/embed/dQw4w9WgXcQ",
      "location": "Field",
      "time": "9AM - 6PM",
      "subOGLink": "https://www.google.com/",
